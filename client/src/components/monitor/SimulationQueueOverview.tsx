    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center justify-between">
          <span>Simulation Queue Progress</span>
      ...
      <CardContent className="space-y-4">
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            <span className="text-gray-600">
              {completedRuns} of {totalRuns} simulations completed
            </span>
        ...
        <div className="grid grid-cols-2 gap-4 pt-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            <div>
              <div className="text-gray-600">Est. Time Remaining</div>
          ...
          <div className="flex items-center gap-2 text-sm">
            ...
            <div>
              ...
              <div className="font-medium">{runningRuns} simulation{runningRuns !== 1 ? 's' : ''}</div>
            </div>
          </div>
        </div>
      </CardContent>
